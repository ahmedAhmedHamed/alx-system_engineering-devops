...
if __name__ == "__main__":
    ...
    """
    users = json.loads(urllib.request.urlopen(f"https://jsonplaceholder.typicode.com/users").read())
    username = None
    exported_json = {}
    for user in users:
        exportable_arr = []
        ...
        user_id = user["id"]
        query_string = f"https://jsonplaceholder.typicode.com/todos?userId={user_id}"
